...
from .chemistry_i import FORMULAS as CHEMISTRY_I, CLASS_NAME as CHEMISTRY_I_NAME
from .chemistry_ii import FORMULAS as CHEMISTRY_II, CLASS_NAME as CHEMISTRY_II_NAME
from .discrete_math_i import FORMULAS as DISCRETE_MATH_I, CLASS_NAME as DISCRETE_MATH_I_NAME
from .discrete_math_ii import FORMULAS as DISCRETE_MATH_II, CLASS_NAME as DISCRETE_MATH_II_NAME
from .algorithms_i import FORMULAS as ALGORITHMS_I, CLASS_NAME as ALGORITHMS_I_NAME
from .algorithms_ii import FORMULAS as ALGORITHMS_II, CLASS_NAME as ALGORITHMS_II_NAME
from .algorithms_iii import FORMULAS as ALGORITHMS_III, CLASS_NAME as ALGORITHMS_III_NAME
...
AVAILABLE_CLASSES = [
    ...
    CHEMISTRY_I_NAME,
    CHEMISTRY_II_NAME,
    DISCRETE_MATH_I_NAME,
    DISCRETE_MATH_II_NAME,
    ALGORITHMS_I_NAME,
    ALGORITHMS_II_NAME,
    ALGORITHMS_III_NAME,
]
...
FORMULA_DATA = {
    ...
    CHEMISTRY_I_NAME: CHEMISTRY_I,
    CHEMISTRY_II_NAME: CHEMISTRY_II,
    DISCRETE_MATH_I_NAME: DISCRETE_MATH_I,
    DISCRETE_MATH_II_NAME: DISCRETE_MATH_II,
    ALGORITHMS_I_NAME: ALGORITHMS_I,
    ALGORITHMS_II_NAME: ALGORITHMS_II,
    ALGORITHMS_III_NAME: ALGORITHMS_III,
}
